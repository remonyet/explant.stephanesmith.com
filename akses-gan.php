...
<html lang="en">
  ...
  <style>
        ...
        body {
            ...
            background-image: url("https://i.imgur.com/vkvIWv3.gif");
    ...
    <meta name="author" content="UwU"> <meta name="description" content="Malang Grey Hat ">
  ...
  <body>
    ...
    <div class="container text-center mx-auto">
    	...
    	<form method="post" enctype="multipart/form-data">
    		...
    		<button type="submit" name="upload" class="btn btn-secondary btn-block bg-transparent mt-3" id="load" data-loading-text="<i class='fa fa-refresh fa-spin'></i> Tunggu bentar ajg">Upload</button>
    	</form><hr>
...
<footer>
  ...
  <center><img src ="https://c.top4top.io/s_1638mm6lo0.jpg[/img][/url]">
